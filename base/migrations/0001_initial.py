...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('mission_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='base.mission')),
                ('type_de_quizz', models.CharField(choices=[('1', 'Quizz Ressources humaines'), ('2', 'Quizz Divers')], default='1', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('debut', models.DateTimeField(default=datetime.datetime(2022, 9, 18, 20, 4, 38, 776261))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_de_missions', models.ManyToManyField(to='base.choix')),
